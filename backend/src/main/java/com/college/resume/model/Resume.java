package com.college.resume.model;
...
public class Resume {
    ...
    public String getAtsAnalysis() { return atsAnalysis; }
    public void setAtsAnalysis(String atsAnalysis) { this.atsAnalysis = atsAnalysis; }

    public String getCareerAdvice() { return careerAdvice; }
    public void setCareerAdvice(String careerAdvice) { this.careerAdvice = careerAdvice; }
